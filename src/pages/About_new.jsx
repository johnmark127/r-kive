                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="team-member">
                                <img src="/assets/images/team/member1.jpg" alt="Team Leader" />
                                <h4>Jimuel Torres</h4>
                                <p>Leader</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="team-member">
                                <img src="/assets/images/team/member2.jpg" alt="Programmer" />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="team-member">
                                <img src="/assets/images/team/member3.jpg" alt="Adviser" />
